function [idxpairs]=pairsindex(c1,c2,rLag,rLagTol,dist,method,handles)
...
case 'kron'
  ...
  for ir=1:nr
    displayString = sprintf('Calculating experimental covariance. Please wait... %5.2f %%',ir/nr*100/2);
...
case 'kronloop'
  ...
  for i=1:n1,
    ...
    for ir=1:nr
      displayString = sprintf('Calculating experimental covariance. Please wait... %5.2f %%',(((i-1)*nr)+ir)/(nr*n1)*100/2);
      set(handles.feedbackEdit,'String',displayString);
      pause(0.01);
