...
for ik=1:nk
  ...
  % The following line has been modified to call the corrected version of
  % pdf2CI, stored in file 'pdfCIgui.m'
  [zlCIik,zuCIik,pdfCI(ik,1:nCI),lCI]=pdf2CIgui(z{ik},pdf{ik},PCI);
  if nCI==1, 
